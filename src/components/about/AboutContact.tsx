      ...
      <AboutSection>
        ...
        <div className="about-text">
          ...
          <h1>
            ...
            პროექტი, რომლის წარმატებაზე საუბარი შეუძლებელია, უბრალოდ ჩვენ გვჯერა
            ამის.
          </h1>
          <h1>
            ამ პრიექტში ჩართულია 10-მდე პირი სხვადასხვა ფუქნცია მოვალეობებით,
          ...
          <h1>
            ...
            გავიდეს საერთაშორისო ასპარეზზეც და ჩვენი ლიგაც შესაბამისად გახდეს
            რეგიონალური.
          </h1>
        </div>
      </AboutSection>
